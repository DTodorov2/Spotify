...
public class DisconnectCommandTest {
    ...
    public void testExecuteWithInvalidArgsCount() {
        ...
        command = new DisconnectCommand(arguments, mockServerResources);
    ...
    public void testExecuteSuccessful() {
        try {
            ...
            fail("The disconnect command could not execute!");
        }

    }

    @Test
    public void testExecuteThrowsUnsuccessfulChannelClosingException() {
        try {
    ...
    @Test
    public void testExecuteWithNoLoggedUser() throws ChannelCommunicationException, InvalidArgumentsCountException {
