...
public class LoginCommandTest {
    ...
    void testExecuteWithIncorrectPassword() {
        String correctHashedPassword = SHA256.hash(EXAMPLE_PASS);
        User user = new User(EXAMPLE_EMAIL, correctHashedPassword, new PlaylistsRepository());
        users.put(EXAMPLE_EMAIL, user);
    ...
    void testSuccessfulLogin() {
        ...
        String[] arguments = new String[]{EXAMPLE_EMAIL, EXAMPLE_PASS};
