...
public class LoginCommandTest {
    ...
    void testUserDoesNotExist() {
        ...
        assertEquals(USER_DOES_NOT_EXIST, result);
    }
    ...
    void testIncorrectPassword() {
        ...
        MockedStatic<SHA256> sha256Mock = mockStatic(SHA256.class);
        sha256Mock.when(() -> SHA256.checkPassword(EXAMPLE_PASS, "hashedPassword")).thenReturn(false);
        sha256Mock.close();
    ...
    void testUserAlreadyLoggedIn() {
        ...
        MockedStatic<SHA256> sha256Mock = mockStatic(SHA256.class);
        sha256Mock.when(() -> SHA256.checkPassword(EXAMPLE_PASS, hashedPass)).thenReturn(true);
        sha256Mock.close();
    ...
    void testSuccessfulLogin() {
        ...
        verify(mockSelectionKey).attach(EXAMPLE_USER_ID);
        assertEquals(SUCCESS_LOGIN, result);
    }
