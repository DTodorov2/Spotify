...
public class AddSongToPlaylistClientCommandTest {
    ...
    void testExecuteWithNullArgs() {
        ...
        assertThrows(IllegalArgumentException.class,
                () -> new AddSongToPlaylistClientCommand(null, mockClientResources,
                        channelDataWriter, channelDataLoader), errMess);
    }

    @Test
    void testExecuteWithBlankStringInTheArray() {
        assertDoesNotThrow(() -> new AddSongToPlaylistClientCommand(userInput, mockClientResources,
    ...
    void testExecuteWithNullServerResourcesArg() {
        ...
        assertThrows(IllegalArgumentException.class,
                () -> new AddSongToPlaylistClientCommand(userInput, null,
                        channelDataWriter, channelDataLoader), errMess);
    }
    ...
    void testExecuteWithNullChannelDataWriter() {
        ...
        assertThrows(IllegalArgumentException.class,
                () -> new AddSongToPlaylistClientCommand(userInput, mockClientResources,
