...
import bg.sofia.uni.fmi.mjt.spotify.command.commands.client.RegisterClientCommand;
...
public class RegisterClientCommandTest {
    ...
    void testExecuteWithNullArgs() {
        ...
        assertThrows(IllegalArgumentException.class,
                () -> new RegisterClientCommand(null, mockClientResources,
                        channelDataWriter, channelDataLoader), errMess);
    }

    @Test
    void testExecuteWithBlankStringInTheArray() {
        assertDoesNotThrow(() -> new RegisterClientCommand(userInput, mockClientResources,
    ...
    void testExecuteWithNullServerResourcesArg() {
        ...
        assertThrows(IllegalArgumentException.class,
                () -> new RegisterClientCommand(userInput, null,
                        channelDataWriter, channelDataLoader), errMess);
    }
    ...
    void testExecuteWithNullChannelDataWriter() {
        ...
        assertThrows(IllegalArgumentException.class,
                () -> new RegisterClientCommand(userInput, mockClientResources,
