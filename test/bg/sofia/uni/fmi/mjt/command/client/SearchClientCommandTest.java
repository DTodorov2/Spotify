...
import bg.sofia.uni.fmi.mjt.spotify.command.commands.client.SearchClientCommand;
...
public class SearchClientCommandTest {
    ...
    public void testExecuteWithNullArgs() {
        ...
        assertThrows(IllegalArgumentException.class,
                () -> new SearchClientCommand(null, mockClientResources,
                        channelDataWriter, channelDataLoader), errMess);
    }

    @Test
    public void testExecuteWithBlankStringInTheArray() {
        assertDoesNotThrow(() -> new SearchClientCommand(userInput, mockClientResources,
    ...
    public void testExecuteWithNullServerResourcesArg() {
        ...
        assertThrows(IllegalArgumentException.class,
                () -> new SearchClientCommand(userInput, null,
                        channelDataWriter, channelDataLoader), errMess);
    }
    ...
    public void testExecuteWithNullChannelDataWriter() {
        ...
        assertThrows(IllegalArgumentException.class,
                () -> new SearchClientCommand(userInput, mockClientResources,
