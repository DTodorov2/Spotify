...
import bg.sofia.uni.fmi.mjt.spotify.command.commands.client.RemoveSongFromPlaylistClientCommand;
...
public class RemoveSongFromPlaylistClientCommandTest {
    ...
    public void testExecuteWithNullArgs() {
        ...
        assertThrows(IllegalArgumentException.class,
                () -> new RemoveSongFromPlaylistClientCommand(null, mockClientResources,
                        channelDataWriter, channelDataLoader), errMess);
    }

    @Test
    public void testExecuteWithBlankStringInTheArray() {
        assertDoesNotThrow(() -> new RemoveSongFromPlaylistClientCommand(userInput, mockClientResources,
    ...
    public void testExecuteWithNullServerResourcesArg() {
        ...
        assertThrows(IllegalArgumentException.class,
                () -> new RemoveSongFromPlaylistClientCommand(userInput, null,
                        channelDataWriter, channelDataLoader), errMess);
    }
    ...
    public void testExecuteWithNullChannelDataWriter() {
        ...
        assertThrows(IllegalArgumentException.class,
                () -> new RemoveSongFromPlaylistClientCommand(userInput, mockClientResources,
