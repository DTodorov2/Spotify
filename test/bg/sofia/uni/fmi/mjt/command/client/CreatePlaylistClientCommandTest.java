...
import bg.sofia.uni.fmi.mjt.spotify.command.commands.client.CreatePlaylistClientCommand;
...
public class CreatePlaylistClientCommandTest {
    ...
    void testExecuteWithNullArgs() {
        ...
        assertThrows(IllegalArgumentException.class,
                () -> new CreatePlaylistClientCommand(null, mockClientResources,
                        channelDataWriter, channelDataLoader), errMess);
    }

    @Test
    void testExecuteWithBlankStringInTheArray() {
        assertDoesNotThrow(() -> new CreatePlaylistClientCommand(userInput, mockClientResources,
                channelDataWriter, channelDataLoader), "The object should be created successfully but is not!");
    }
    ...
    void testExecuteWithNullServerResourcesArg() {
        ...
        assertThrows(IllegalArgumentException.class,
                () -> new CreatePlaylistClientCommand(userInput, null,
                        channelDataWriter, channelDataLoader), errMess);
    }
    ...
    void testExecuteWithNullChannelDataWriter() {
        ...
        assertThrows(IllegalArgumentException.class,
                () -> new CreatePlaylistClientCommand(userInput, mockClientResources,
