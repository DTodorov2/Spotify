...
public class PlaySongServerCommandTest {
    ...
    public void testExecuteWithInvalidArgsCount() {
        command.setArguments(new String[]{TEST_PARAMETER, TEST_PARAMETER});
    ...
    public void testExecuteWithNullServerResourcesArgument() {
        ...
        assertThrows(IllegalArgumentException.class,
                () -> new PlaySongServerCommand(new String[]{TEST_PARAMETER}, null), errMess);
    }

    @Test
    public void testExecuteWithNullStringArgument() {
    ...
    private String executeCommand() {
        try {
            ...
            fail("The play command could not execute! Reason: " + e.getMessage());
        }
