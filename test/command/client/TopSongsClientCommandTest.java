...
import bg.sofia.uni.fmi.mjt.spotify.command.commands.client.TopSongsClientCommand;
...
public class TopSongsClientCommandTest {
    ...
    public void testExecuteWithNullArgs() {
        ...
        assertThrows(IllegalArgumentException.class,
                () -> new TopSongsClientCommand(null, mockClientResources,
                        channelDataWriter, channelDataLoader), errMess);
    }

    @Test
    public void testExecuteWithBlankStringInTheArray() {
        assertDoesNotThrow(() -> new TopSongsClientCommand(userInput, mockClientResources,
                channelDataWriter, channelDataLoader), "The object should be created successfully!");
    }

    @Test
    public void testExecuteWithNullServerResourcesArgument() {
        String errMess = "IllegalArgumentException is expected to be thrown " +
                "when a null server resources argument is passed!";

        assertThrows(IllegalArgumentException.class,
                () -> new TopSongsClientCommand(userInput, null,
                        channelDataWriter, channelDataLoader), errMess);
    }
    ...
    public void testExecuteWithNullChannelDataWriter() {
        ...
        assertThrows(IllegalArgumentException.class,
                () -> new TopSongsClientCommand(userInput, mockClientResources,
