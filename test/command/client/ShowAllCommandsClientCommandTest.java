...
public class ShowAllCommandsClientCommandTest {
    ...
    void testExecuteWithNullArgs() {
        ...
        assertThrows(IllegalArgumentException.class,
                () -> new ShowAllCommandsClientCommand(null, mockClientResources,
                        channelDataWriter, channelDataLoader), errMess);
    }

    @Test
    void testExecuteWithBlankStringInTheArray() {
        assertDoesNotThrow(() -> new ShowAllCommandsClientCommand(userInput, mockClientResources,
    ...
    void testExecuteWithNullServerResourcesArgument() {
        ...
        assertThrows(IllegalArgumentException.class,
                () -> new ShowAllCommandsClientCommand(userInput, null,
                        channelDataWriter, channelDataLoader), errMess);
    }
    ...
    void testExecuteWithNullChannelDataWriter() {
        ...
        assertThrows(IllegalArgumentException.class,
                () -> new ShowAllCommandsClientCommand(userInput, mockClientResources,
