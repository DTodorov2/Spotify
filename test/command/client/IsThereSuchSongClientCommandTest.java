...
import bg.sofia.uni.fmi.mjt.spotify.command.commands.client.IsThereSuchSongClientCommand;
...
public class IsThereSuchSongClientCommandTest {
    ...
    void testExecuteWithNullArgs() {
        ...
        assertThrows(IllegalArgumentException.class,
                () -> new IsThereSuchSongClientCommand(null, mockClientResources,
                        channelDataWriter, channelDataLoader), errMess);
    }

    @Test
    void testExecuteWithBlankStringInTheArray() {
        assertDoesNotThrow(() -> new IsThereSuchSongClientCommand(userInput, mockClientResources,
    ...
    void testExecuteWithNullServerResourcesArgument() {
        ...
        assertThrows(IllegalArgumentException.class,
                () -> new IsThereSuchSongClientCommand(userInput, null,
                        channelDataWriter, channelDataLoader), errMess);
    }
    ...
    void testExecuteWithNullChannelDataWriter() {
        ...
        assertThrows(IllegalArgumentException.class,
                () -> new IsThereSuchSongClientCommand(userInput, mockClientResources,
