...
public class CommandExecutorTest {
    ...
    void testExecuteSimpleCommand() {
        try {
            ...
            String result = commandExecutor.execute(LOGIN_COMMAND + " " + EXAMPLE_USER_EMAIL + " " + EXAMPLE_USER_PASS);
    ...
    void testExecutePlayCommandWithSongTitleWithMoreThanOneWord() {
        try {
            ...
            String result = commandExecutor.execute(PLAY_COMMAND + " " + EXAMPLE_SONG_TITLE + " " + EXAMPLE_SONG_TITLE);
            ...
            fail("The testExecutePlayCommandWithSongTitleWithMoreThanOneWord test cannot be executed: " + e.getMessage());
        }
    }
    ...
    void testExecuteAddSongToCommand() {
        try {
            ...
            String result = commandExecutor.execute(ADD_COMMAND + " " + EXAMPLE_SONG_ARTIST + " " + EXAMPLE_SONG_TITLE);
    ...
    void testExecuteWithRemoveSongCommand() {
        try {
            ...
            String result = commandExecutor.execute(REMOVE_COMMAND + " " + EXAMPLE_SONG_ARTIST + " " + EXAMPLE_SONG_TITLE);
