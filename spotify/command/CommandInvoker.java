...
import bg.sofia.uni.fmi.mjt.spotify.command.commands.keyBased.LoginCommand;
import bg.sofia.uni.fmi.mjt.spotify.command.commands.nonKeyBased.RegisterCommand;
import bg.sofia.uni.fmi.mjt.spotify.command.commands.keyBased.SearchCommand;
...
public class CommandInvoker {
    ...
    public CommandInvoker(UsersRepository usersRepository, SongsRepository songsRepository) {
        ...
        commandMap.put(REGISTER, (args, key) -> new RegisterCommand(args, usersRepository));
