...
public abstract class ClientCommand extends Command {
    ...
    public ClientCommand(String userInput, String[] arguments, int expectedCountArguments,
        ...
        channelDataLoader = new ChannelDataLoader(clientResources.getBuffer(), clientResources.getClientChannel());
        channelDataWriter = new ChannelDataWriter(clientResources.getBuffer(), clientResources.getClientChannel());
    }
