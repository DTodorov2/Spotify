...
public class RemovePlaylistClientCommand extends ClientCommand {

    private static final int EXPECTED_INPUT_LENGTH = 1;

    public RemovePlaylistClientCommand(String userInput, String[] arguments, ClientResources clientResources) {
