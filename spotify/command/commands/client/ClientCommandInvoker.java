...
public class ClientCommandInvoker implements CommandInvoker {
    ...
    public ClientCommandInvoker(ClientResources clientResources) {
        ...
        clientCommandMap.put(TOP,
                (input, args) -> new TopSongsClientCommand(input, args, clientResources));
        ...
        clientCommandMap.put(CHECK_SONG,
                (input, args) -> new IsThereSuchSongClientCommand(input, args, clientResources));
        clientCommandMap.put(PLAY,
                (input, args) -> new PlaySongClientCommand(input, args, clientResources));
        clientCommandMap.put(STOP,
                (input, args) -> new StopSongClientCommand(input, args, clientResources));
    }
    ...
    public String executeCommand(String command, String[] args) throws ChannelCommunicationException {
        ...
        Command newCommand = commandToExecute.create(wholeInput, args);
