...
public class AddSongWithArtistToPlaylistCommand extends ServerCommand {

    private static final int EXPECTED_INPUT_LENGTH = 3;

    public AddSongWithArtistToPlaylistCommand(String[] arguments, ServerResources serverResources) {
