...
public class AddSongToPlaylist extends ServerCommand {

    private static final int EXPECTED_INPUT_LENGTH = 2;

    public AddSongToPlaylist(String[] arguments, ServerResources serverResources) {
    ...
    public String execute() {
        ...
        if (!playlistToAddSongTo.addSong(songsWithThisName.getFirst())) {
            return "This song is already in the playlist!";
        }

        return "Song: " + songName + " is added successfully to playlist: " + playlistName;
    }
}
