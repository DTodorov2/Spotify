...
public class CommandExecutor {
    ...
    private String[] isArgsModificationNeeded(String command, String[] args, String[] tokens) {
        ...
        int startIndex = isSuccessfulSongModificationCommand ? 2 :
                isSuccessfulPlayCommand ? 1 : 0;
        ...
        return isSuccessfulSongModificationCommand ?
                ...
                isSuccessfulPlayCommand ? new String[]{String.join(ARGS_JOIN_DELIMITER, songName)} : args;
    }
