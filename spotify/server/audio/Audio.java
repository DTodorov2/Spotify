...
public class Audio implements Runnable {
    ...
    public Audio(String songName, SocketChannel socketChannel) {
        ...
        channelDataWriter = new ChannelDataWriter(buffer, socketChannel);
        isStreaming = false;
    }
    ...
    private void startStreaming() throws IOException, SerializationDataException {
        while (isStreaming) {
    ...
    public void stopStreaming() {
        ...
        //tuk ne trqbv li da se zatvarq i socketChannel-a ???
