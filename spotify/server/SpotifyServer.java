...
public class SpotifyServer {
    ...
    public SpotifyServer() {
        ...
        commandExecutor = new CommandExecutor(serverResources, new ServerCommandInvoker(serverResources));
    ...
    private void handleKey(SelectionKey key) throws HandlingSelectionKeyException {
        ...
        try {
            ...
            String message = "Unable to process a selection key ";
            throw new HandlingSelectionKeyException(message, e);
        }
    }
    ...
    private void writeClientOutput(SocketChannel clientChannel, String output) throws IOException {
        checkArgumentNotNull(output, "output string");
        checkArgumentNotNull(clientChannel, "client channel");
