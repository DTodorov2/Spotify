...
import bg.sofia.uni.fmi.mjt.spotify.exception.unchecked.InvalidArgumentsCountException;
...
public class Validator {
    ...
    public static void validateArgCount(String[] args, int expectedCount) {
    ...
    public static void validateUserCredentials(String email, String pass) throws InvalidUserAuthenticationException {
        ...
        if (pass.length() < MIN_LEN_PASS) {
            throw new InvalidUserAuthenticationException("The password must be at least " + MIN_LEN_PASS + " characters long!");
        }
    }
